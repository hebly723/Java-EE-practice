...
public class OrderMaster_add extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public OrderMaster_add() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		om.setOrderDate(request.getParameter("orderDate").toString());
